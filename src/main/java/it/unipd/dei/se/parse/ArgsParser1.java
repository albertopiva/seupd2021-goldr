 ...
 */
public class ArgsParser1 extends it.unipd.dei.se.parse.DocumentParser {
     ...
     *                                  parser.
     */
    public ArgsParser1(final Reader in) {
            ...
            if (jp.nextToken() != JsonToken.END_OBJECT) {
                ...
                if (!fieldName.equals("arguments")) {
                    ...
                    if (current == JsonToken.START_ARRAY) {
                        System.out.println("ArgsParser1: ready to parse arguments.");
                    } else {
