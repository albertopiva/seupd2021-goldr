 ...
 */
public class ArgsParser2 extends it.unipd.dei.se.parse.DocumentParser {
     ...
     *                                  parser.
     */
    public ArgsParser2(final Reader in) {
            ...
            if (jp.nextToken() != JsonToken.END_OBJECT) {
                ...
                if (!fieldName.equals("arguments")) {
                    ...
                    if (current == JsonToken.START_ARRAY) {
                        System.out.println("ArgsParser2: ready to parse arguments.");
                    } else {
    ...
    public boolean hasNext() {
        ...
        try {
            ...
            if (jp.nextToken() != JsonToken.END_ARRAY) {
                ...
                sourceText = context.get("sourceText").asText();
                sConclusionStart = context.get("sourceTextConclusionStart").asInt();
                sConclusionEnd = context.get("sourceTextConclusionEnd").asInt();
                sPremiseStart = context.get("sourceTextPremiseStart").asInt();
                sPremiseEnd = context.get("sourceTextPremiseEnd").asInt();

                start = Math.min(sConclusionStart, sPremiseStart);
                end = Math.max(sConclusionEnd, sPremiseEnd);

                body.append(topic);
                body.append(" ");
                body.append(sourceText.substring(start, end));
        ...
        if (id != null) {
            ...
            document = new it.unipd.dei.se.parse.ParsedDocument(id, "#",body.length() > 0 ? body.toString() : "#", stance);
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        ArgsParser p = new ArgsParser(reader);
